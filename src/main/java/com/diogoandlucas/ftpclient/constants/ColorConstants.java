package com.diogoandlucas.ftpclient.constants;

import java.awt.*;

public class ColorConstants {

    public final static Color BACKGROUND = new Color(58,58,58);
    public final static Color LABEL = new Color(232,223, 223);
